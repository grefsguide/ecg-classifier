    ...
    try:
        ...
        try:
            ...
            created_model = repo.create(
                ...
                metrics_uri=result.get("metrics_uri"),
            ...
            response = {
                ...
                "checkpoint_uri": created_model.checkpoint_uri,
                "metrics_uri": created_model.metrics_uri,
                "storage_backend": created_model.storage_backend,
